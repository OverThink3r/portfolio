...
export const Carousel = () => {
  ...
  const prevSlide = () => {
    setCurrent(prev => prev === 0 ? imgSrcs.length - 1 : prev - 1)
  }

  const nextSlide = () => { 
    setCurrent(prev => prev === imgSrcs.length - 1 ? 0 : prev + 1)
  }

  const setCourse = (idx: number) => {
    setCurrent(idx)
  }
  ...
  return (
    <div className="overflow-hidden relative">
      ...
      <div className="absolute bottom-4 right-0 left-0 -mb-3">
